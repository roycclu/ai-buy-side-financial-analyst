...
| 2026-02-23 | LLM provider refactor. Removed Ollama-specific adapter and models/ directory. New openai_adapter.py covers OpenAI, Gemini, and any local OpenAI-compatible server (e.g. http://127.0.0.1:17777/v1). Config now uses ANTHROPIC_MODEL / OPENAI_BASE_URL / OPENAI_API_KEY / OPENAI_MODEL env vars. LLM_PROVIDER=openai|anthropic. |
